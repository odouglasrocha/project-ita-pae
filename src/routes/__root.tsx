  ...
  head: () => ({
    meta: [
      ...
      { title: "InspectorLS — Validação de impressão industrial" },
      {
        name: "description",
        content:
          "Scanner contínuo para validação de data de validade, código juliano e inspeção de qualidade em embalagens industriais.",
      },
      { property: "og:title", content: "InspectorLS — Validação de impressão industrial" },
      {
        property: "og:description",
        content:
          "Scanner industrial de validade, código juliano LS e inspeção de qualidade.",
      },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "InspectorLS — Validação de impressão industrial" },
